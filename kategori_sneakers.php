...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="home.php">StartShop</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="Kategori_running.php">Running</a>
            <a class="dropdown-item" href="kategori_slip_on.php">Slip on</a>
          </div>
          </li>
           <li class="nav-item">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <p class="text-white-50 mb-4">StartShop has everything you need to get your new experience style and no need to worry abaut wasting your time</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <thead>
    ...
    $query="select *from barang where model='sneakers'";
